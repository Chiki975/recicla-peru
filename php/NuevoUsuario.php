            ...
            <div class="flex justify-center self-center  z-10">
                <div class="p-12 bg-primary mx-auto rounded-2xl w-100 ">
					...
					<form  onsubmit="" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="POST">
                        <div class="space-y-5">
                            <div class="space-y-2">
                                <label class="text-sm font-medium text-white tracking-wide">DNI</label>
                                <input
                                    class=" w-full text-base px-4 py-2 border  border-gray-300 rounded-lg focus:outline-none focus:border-green-400"
                                    type="" placeholder="02147852" name="DNI">
									<span class="msg-error"><?php echo $username_err; ?></span>
                            </div>
							<div class="space-y-2">
                                <label class="text-sm font-medium text-white tracking-wide">NOMBRE</label>
                                <input
                                    class=" w-full text-base px-4 py-2 border  border-gray-300 rounded-lg focus:outline-none focus:border-green-400"
                                    type="" placeholder="usuario" name="NOMBRE">
									<span class="msg-error"><?php echo $username_err; ?></span>
                            </div>
							<div class="space-y-2">
                                ...
                                <input
                                    class=" w-full text-base px-4 py-2 border  border-gray-300 rounded-lg focus:outline-none focus:border-green-400"
                                    type="" placeholder="Recicla@gmail.com" name="email">
                            ...
                            <div class="space-y-2">
                                ...
                                <input
                                    ...
                                    type="password" placeholder="Ingresa tu contraseña" name="password">
                            ...
                            <div class="flex items-center justify-between">
                                ...
                                <div class="text-sm">
                                    <a href="../index.php" class="text-white hover:text-green-500">
                                        Iniciar Sección &nbsp;&nbsp;
